...
export const CreateTaskInputSchema = z.object({
  ...
  due: z.string().optional().describe("Due date — YYYY-MM-DD (converted to end-of-day) or full ISO 8601 datetime"),
  snoozeUntil: z.string().optional().describe("Don't schedule before this date — YYYY-MM-DD (converted to start-of-day) or full ISO 8601 datetime"),
...
export const UpdateTaskInputSchema = z.object({
  ...
  due: z.string().optional().describe("New due date — YYYY-MM-DD (converted to end-of-day) or full ISO 8601 datetime"),
  snoozeUntil: z.string().optional().describe("New snooze-until date — YYYY-MM-DD (converted to start-of-day) or full ISO 8601 datetime"),
